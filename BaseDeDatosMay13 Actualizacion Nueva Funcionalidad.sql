...
DROP DATABASE BaseDeDatosMay13;

CREATE DATABASE BaseDeDatosMay13;

USE BaseDeDatosMay13;

#este campo sirve para crear las tablas createdAt y updatedAt,13/05/2025, quedo con las pruebas hechas y todo funcional#
...
CREATE TABLE SolicitudApoyo (
    ...
    IdUsuario INT NOT NULL, -- Id del usuario de rol aprendiez que ha hecho la solicitud
  ...
  Comentario TEXT,
  RolUsuario INT NOT NULL, -- el id de usuario debe ser del rol especialista
  ...
  CREATE TABLE RadicadoPDF (
  IdRadicado INT AUTO_INCREMENT PRIMARY KEY,
  IdSolicitud INT NOT NULL,
  RutaArchivo VARCHAR(255) NOT NULL,
  CONSTRAINT FK_Solicitud_Radicado FOREIGN KEY (IdSolicitud) REFERENCES SolicitudApoyo(IdSolicitud) ON DELETE CASCADE
);

  
  
  
ALTER TABLE usuario ADD COLUMN createdAt DATETIME DEFAULT CURRENT_TIMESTAMP; 
ALTER TABLE usuario ADD COLUMN updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP;